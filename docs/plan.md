...
- **流量监测功能** (2024-03-03 完成，2024-03-05 移除) ❌
  - 已移除：不需要统计功能，只保留消息转发核心功能
  - 移除原因：简化代码，减少不必要的性能开销
...
- **v0.5.0** (2024-03-05) - 性能优化
  - 删除流量统计功能，简化代码
  - 优化适配器创建方式，复用 HTTP 连接池
  - 预期性能提升 10-30%
...
- **v0.4.0** (2024-03-03) - 流量监测功能（已在 v0.5.0 移除）
  - 基于小时级别时间桶的内存统计
